          ...
          >
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-2xl bg-[#0B3D20]/10 text-[#0B3D20] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-xs sm:text-sm text-[#4A4A4A]">
                    <div className="flex justify-between gap-4">
                      ...
                      <strong className="text-[#0B3D20]">06:30 - 20:00 WIB</strong>
                    </div>
                    <div className="flex justify-between gap-4">
                      <span>Minggu &amp; Libur:</span>
                      <strong className="text-[#0B3D20]">07:00 - 18:00 WIB</strong>
                    </div>
                  </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-['Playfair_Display',serif] text-base font-bold text-[#0B3D20] mb-2">
                  ...
                  <div className="space-y-2">
                    {WA_NUMBERS.map((contact) => (
                      <a
                        ...
                        className="flex items-center justify-between p-2.5 rounded-xl bg-[#FDFBF7] hover:bg-[#F5E6C8]/50 border border-[#E8E4DC] text-xs font-semibold text-[#0B3D20] transition-colors"
                      >
                        <span>{contact.display}</span>
                        <span className="text-[10px] text-[#1E673C] font-bold">Chat WA →</span>
                      </a>
                    ))}
                  </div>
                </div>
            ...
            <div className="mt-8 pt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 bg-[#0B3D20] hover:bg-[#134E2C] text-white font-semibold text-xs sm:text-sm py-3.5 px-6 rounded-xl shadow-md transition-all active:scale-95"
              >
